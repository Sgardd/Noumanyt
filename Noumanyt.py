...
----------------------------------------------
 ...
 Version   : 1.0
----------------------------------------------
 NOUMAN SHAR  Pro version 1.0
 For Haters: MARE DOST SAMMAD AZHAR PARVEZ SHOAIB JAWAD KASIF 🤞
\033[1;37m----------------------------------------------""")
def linex():
        print('\033[1;37m----------------------------------------------')
def clear():
...
def menu():
        ...
        #       chk()
                ...
                if x == ("sex"):
                        ...
                        linex()
                        tks = ("Hi Aking Sir, I Need To Buy Your Paid NOUMAN SHAR  PRO Tools Version 1.0 Premium Please Accept My Key To Premium :)\n\n Name :- "+name+"\n Key :- "+fkeyx)
